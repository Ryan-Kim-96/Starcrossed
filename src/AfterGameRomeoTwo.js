...
import articleImage from './Warmth.png'
    ...
    return (
        ...
        <div className="post">
            ...
            <div className="post_headname">
                <text className="post_headname_text">no hand to hold </text>
            </div>
          ...
          <div style={{paddingTop: "20px"}}>
            <div className="comment_commentsection">
              <div>
                <Image className="comment_commentsection_profile" style={{cursor:"pointer"}} src={Mercutio} roundedCircle />

              </div>
              <div className="comment_commentsection_name">
                <text><strong>Mercutio</strong> <text className="comment_timestamp">20 mins ago</text></text>
              </div>
            </div>

            <div>
              <div className="comment_write" style={{paddingBottom: "20px"}}>
                <text>I’ll hold your hand bro💛</text>
