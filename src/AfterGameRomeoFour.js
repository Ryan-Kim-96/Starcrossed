...
import articleImage from './head.png'
    ...
    return (
        ...
        <div className="post">
            ...
            <div className="post_headname">
                <text className="post_headname_text">gotta find some place to clear my head and forget</text>
            </div>
          ...
          <div style={{paddingTop: "20px"}}>
            ...
            <div>
              <div className="comment_write" >
                <text>Ey what about crashing a party tonight, bro?? </text>
          ...
          <div className="subcomment" >
            ...
            <div className="comment_write" style={{paddingBottom:"20px"}}>
              <text>LEGGOOO!! @Benny meet ya at Romeo’s place at 5</text>
            </div>
          </div>
