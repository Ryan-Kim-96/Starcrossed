      ...
      <Modal.Body >
        ...
        <div className="sharebox">
          ...
          <div className="share_post_label">
            <h4><strong>Verona Square 9:30 a.m.</strong></h4>
            <text><strong>Breaking news:</strong> This morning, Capulet employees
            instigated a brawl with several Montague employees on the street.
            The Montagues claim they didn't want to start a conflict and were
            afraid of harming innocent people, but Capulets ignored their pleas
            and caused chaos in the streets for the sake of unwarranted vengeance.  </text>
          </div>
        </div>
        <div className="share_buttonbox">
          <Button onClick={props.onHide}>Close</Button>
          <div className="spacing"></div>
          <Link to="/badend"><Button style={{paddingTop:"10px", paddingBottom: "10px"}}>Post</Button></Link>
        </div>
      </Modal.Body>
